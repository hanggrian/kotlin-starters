...
inline fun <reified T : Plugin<*>> Project.withPlugin(noinline action: Plugin<*>.() -> Unit) =
    plugins.withType<T>().configureEach(action)

inline fun <reified T : Plugin<*>> Project.withPluginEagerly(noinline action: Plugin<*>.() -> Unit) =
